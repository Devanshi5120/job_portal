...
<div class="card">
    <div class="card-body">
        {!! Form::model($about, ['method' => 'PUT','enctype'=>"multipart/form-data", 'route' => ['about.update', $about->id]]) !!}
                @csrf
                ...
                <div class="col-12 ">
                    <a class="btn btn-primary" href="{{ route('about.index') }}" style="margin-left: 130px;"> Back</a>

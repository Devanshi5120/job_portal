                ...
                <a class="nav-link" href="{{ route('job.index')}}">
                   ...
                   <li class="nav-item active">
                    <a class="nav-link" href="{{ route('recruiter.index')}}">
                      ...
                      <!-- Nav Item - Dashboard -->
                      <li class="nav-item active">
                        <a class="nav-link" href="{{ route('jobseeker.index')}}">
                            <i class="fas fa-fw fa-tachometer-alt"></i>
                     ...
                     <!-- Nav Item - Dashboard -->
                     <li class="nav-item active">
                        <a class="nav-link" href="{{ route('applicantcv.index')}}">
                            <i class="fas fa-fw fa-tachometer-alt"></i>
                            <span>Applicant CV</span></a>
                    </li>
                    ...
                    <li class="nav-item">
                        ...
                        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                            <div class="bg-white py-2 collapse-inner rounded">
                                ...
                                <a class="collapse-item" href="{{ route('contactinfo.index')}}">ContactInfo</a>
                                <a class="collapse-item" href="{{ route('baner.index')}}">Baner</a>
                                <a class="collapse-item" href="{{ route('apply.index')}}">Applies</a>
                                <a class="collapse-item" href="{{ route('work.index')}}">How to Work</a>
        ...
        <footer class="sticky-footer bg-white">
            <div class="container my-auto">
                <div class="copyright text-center my-auto">
                    <span>Copyright &copy; Inventory Management System 2022</span>
                </div>
            </div>
        </footer>
        <!-- End of Footer -->
...
<!-- End of Page Wrapper -->
  ...
  <script src="https://cdn.tiny.cloud/1/hhzmmukorrr5mabxa048rk4gakvisv6jc883phcm2whajb3h/tinymce/6/tinymce.min.js" referrerpolicy="origin"></script>

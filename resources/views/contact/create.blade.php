                    ...
                    <div class="col-lg-8">
                        ...
                        <form  class="row g-3" method="POST" action="{{ route('contact.store') }}">
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control form-livedoc-control" name="message"id="message" placeholder="Message" style="height: 250px;" required="required"></textarea>
                              </div>

                              <div class="col-md-6  border-style: solid;
                              border-width: thin;">
                                <label class="visually-hidden" for="inputName">Name</label>
                                <input class="form-control form-livedoc-control" name="name" id="name" type="text" placeholder="Name" />
                              </div>

                              <div class="col-md-6">
                                <label class="form-label visually-hidden" for="inputEmail">Email</label>
                                <input class="form-control form-livedoc-control" name="email" id="email" type="email" placeholder="Email" />
                              </div>

                      
                          <div class="col-md-6">
                            <label class="visually-hidden" for="inputName">Subject</label>
                            <input class="form-control form-livedoc-control" name="subject" id="subject" type="text" placeholder="Subject" />
                          </div> <br><br>

                ...
                <div class="job-category-listing mb-50">
                    ...
                    <div class="single-listing">
                       <div class="small-section-tittle2">
                        ...
                        <form action="{{ route('frontend.job_listing') }}" method="POST">
                                @csrf
            ...
            <div class="col-xl-9 col-lg-9 col-md-8">
                ...
                <section class="featured-job-area">
                    <div class="container">
                        ...
                        <!-- single-job-content -->
                        @foreach ($jobs as $job)
                        <div class="single-job-items mb-ss">
                            <div class="job-items">
                                ...
                                <div class="job-tittle job-tittle2">
                                    ...
                                    <li></li>
                                    <ul>
                                        <li><h5>'{{$job->jobcategory->name}}'</h5></li>
                            ...
                            <div class="items-link items-link2 f-right">
                                <a href="{{ route('frontend.job_details',$job->id) }}">{{ $job->type}}</a>
                                <span><span>
                            </div>
                        </div>
                        @endforeach
